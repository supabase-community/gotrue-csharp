...
namespace Supabase.Gotrue
{
    ...
    public class Api : IGotrueApi<User, Session>
    {
        ...
        /// <inheritdoc />
        public Task<SSOResponse?> SignInWithSSO(Guid providerId, SignInWithSSOOptions? options = null) => SignInWithSsoInternal(providerId, options: options);
        ...
        public Task<MfaChallengeResponse?> Challenge(string jwt, MfaChallengeParams mfaChallengeParams) =>
            Helpers.MakeRequest<MfaChallengeResponse>(HttpMethod.Post, $"{Url}/factors/{mfaChallengeParams.FactorId}/challenge", null, CreateAuthedRequestHeaders(jwt));
        ...
        public Task<MfaUnenrollResponse?> Unenroll(string jwt, MfaUnenrollParams mfaUnenrollParams) =>
            Helpers.MakeRequest<MfaUnenrollResponse>(HttpMethod.Delete, $"{Url}/factors/{mfaUnenrollParams.FactorId}", null, CreateAuthedRequestHeaders(jwt));

        /// <inheritdoc />
        public Task<BaseResponse> ListFactors(string jwt, MfaAdminListFactorsParams listFactorsParams) =>
            Helpers.MakeRequest(HttpMethod.Get, $"{Url}/admin/users/{listFactorsParams.UserId}/factors", null, CreateAuthedRequestHeaders(jwt));

        /// <inheritdoc />
        public Task<MfaAdminDeleteFactorResponse?> DeleteFactor(string jwt, MfaAdminDeleteFactorParams deleteFactorParams) => Helpers.MakeRequest<MfaAdminDeleteFactorResponse>(HttpMethod.Delete,
            $"{Url}/admin/users/{deleteFactorParams.UserId}/factors/{deleteFactorParams.Id}", null, CreateAuthedRequestHeaders(jwt));
